...
class ValidationConfig:
    ...
    redact_pii: bool = True  # Security by default: redact PII unless explicitly disabled
...
# PII patterns (simplified - consider using a dedicated library for production)
PII_PATTERNS = {
