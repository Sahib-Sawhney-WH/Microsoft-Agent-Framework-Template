...
You must create a **Data Access Policy** assignment. See [Azure Setup](../deployment/azure-setup.md).
...
| Load | Recommendation |
|------|----------------|
| Low (< 100 sessions) | Basic tier |
| Medium (100-1000) | Standard tier |
| High (> 1000) | Premium tier with clustering |

### Storage Scaling

- Use **hot tier** for recent sessions
- Consider **cool tier** for archived sessions
...
- Use **GRS storage** for data redundancy
...
- [Architecture Overview](../architecture/index.md) — Memory architecture
