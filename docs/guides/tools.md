...
tool_modules = ["src.my_tools.tools"]  # Explicit module paths
```
...
```python
@register_tool(name="async_tool", tags=["async"])
...
- [Architecture Overview](../architecture/index.md) — Tool loading architecture
